<template>
    <MainLayout>
        <ShowcaseBanner img="/assets/images/mot/showcase.png">
            MOT Test Centre
        ...
        <div class="container py-10 flex space-x-16">
            <div>
                ...
                <img src="/assets/images/mot/mot-1.jpg" alt="MOT Test being carried out 1" class="w-full h-96 object-cover">
                ...
                <div class="py-10 space-y-6">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <img class="w-96 h-80 object-cover" src="/assets/images/mot/mot-2.jpg" alt="MOT Test being carried out 2">
                    </div>
                </div>
            </div>
