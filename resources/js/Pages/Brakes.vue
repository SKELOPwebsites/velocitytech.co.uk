<template>
    <MainLayout>
        <ShowcaseBanner img="/assets/images/brakes/showcase.png">
        ...
        <div class="container py-10 flex space-x-16">
            <div>
                ...
                <img src="/assets/images/brakes/brake-pads.jpg" alt="Brake pad and discs replacement" class="w-full h-96 object-cover">
                ...
                <div class="py-10 space-y-6">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <img class="w-96 h-80 object-cover" src="/assets/images/brakes/brakes.jpg" alt="Brake pad replacement">
                    </div>
                </div>
            </div>
