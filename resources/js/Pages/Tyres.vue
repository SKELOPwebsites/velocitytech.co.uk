<template>
    <MainLayout>
        <ShowcaseBanner img="/assets/images/tyres/showcase.png">
        ...
        <div class="container py-10 flex space-x-16">
            <div>
                ...
                <img src="/assets/images/tyres/quality-tyres.jpg" alt="Roster of premium and high quality tyres" class="w-full h-96 object-cover object-bottom">
                ...
                <div class="py-10 space-y-6">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <img class="w-96 h-80 object-cover" src="/assets/images/tyres/tyre-change.jpg" alt="tyre being changed at the garage">
                    </div>
                </div>
            </div>
